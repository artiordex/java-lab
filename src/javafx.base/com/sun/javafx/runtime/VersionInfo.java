...
public class VersionInfo {
     ...
     * Build Timestamp.
     */
    private static final String BUILD_TIMESTAMP = "2023-10-17T16:04:51Z";
     ...
     * Hudson Build Number.
     */
    private static final String HUDSON_BUILD_NUMBER = "201";

    /**
     * Promoted build number used as part of the runtime version string.
     */
    private static final String PROMOTED_BUILD_NUMBER = "6";

    /**
     * Raw Version number string. (without milestone tag)
     */
    private static final String RELEASE_VERSION = "21.0.1";
